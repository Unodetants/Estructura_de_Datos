...
public class PruebaListaSimple2 {
    public static void main(String[] args) {
        ...
        System.out.println("Usuarios en la lista simple:");
     ...
     // Pedir por consola un nuevo usuario para ser insertado al principio
        ...
        String dir1[] = direccionInput.split(" ");
		
		if (dir1.length == 4) {
			dir = new Direccion(dir1[0], dir1[1], dir1[2], dir1[3], null, null);
		} else {
			dir = new Direccion(dir1[0], dir1[1], dir1[2], dir1[3], dir1[4],
					dir1[5]);
		}
     ...
     // Pedir por consola un nuevo usuario para ser insertado al final
        ...
        System.out.println("\nUsuarios en la lista simple después de las inserciones:");
        current = lista.first();
        while (current != null) {
            System.out.println(current.getData());
            current = current.getNext();
